...
export const SynthesisOutputSchema = z.object({
  stories: z.array(
    z.object({
      ...
      score: z.number().describe('Internal calculated final score out of 10. Never show this in the final email or markdown.'),
      ...
      }).describe('Internal score components. Never show these in the final email or markdown.'),
      category: z.enum([
...
export const synthesisAgent = new Agent({
  ...
  tools: [],
  handoffDescription: 'Use this agent to deduplicate gathered news, evaluate sources, verify official document facts, tag stories, and assign confidence levels.',
});
