...
import { getPublishedNews, getPublishedNewsById, likeNews, unlikeNews, getMyLikedNews, searchPublishedNews } from "../controllers/news.controller.js";
import requireAuth from "../middlewares/requireAuth.js";
import validate from "../middlewares/validate.js";
import { idParamSchema, newsSearchSchema } from "../schemas/common.schema.js";

const router = Router();

router.get("/", requireAuth, getPublishedNews);
router.get("/liked", requireAuth, getMyLikedNews);
router.get("/search", requireAuth, validate(newsSearchSchema, "query"), searchPublishedNews);
