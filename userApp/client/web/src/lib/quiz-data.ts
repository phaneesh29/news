...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    correctAnswer: 0,
    explanation: "The regular expression lacks a trailing anchor `export type Difficulty = "easy" | "medium" | "hard" | "expert" | "chaos";
...
export const quizQuestions: QuizQuestion[] = [
  ...
  },
  {
    ...
    correctAnswer: 1,
    explanation: "Attackers use injections (like 'Ignore previous instructions...') to hijack the LLM. Using strict delimiters separates the instructions from the payload. Placing core system instructions at the very end of the prompt also leverages the 'recency bias' of attention mechanisms, overriding the attacker's payload."
  }. It checks if the Origin *starts with* `https://example.com` or `https://www.example.com`. Therefore, an origin like `https://example.com.attacker.com` (which the attacker controls) perfectly matches the regex and bypasses the CORS validation."
  },
  {
    id: "security-10",
    role: "Security Engineer",
