        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-6">
            <Link href="/news" className="flex items-center gap-2.5 group select-none">
              {/* DevBits Logo */}
              <div className="flex h-12 w-12 p-[2px] items-center justify-center border-2 border-current bg-transparent text-current transition-transform group-hover:scale-105 duration-200 rounded-md">
                <div className="relative w-full h-full">
                  <Image src="/devbits-logo.png" alt="DevBits Logo" fill sizes="48px" className="object-contain" />
                </div>
              </div>
