...
function VerifyContent() {
  ...
  return (
    <div className="min-h-screen w-screen bg-[#f5f2e9] flex items-center justify-center p-4 relative overflow-hidden font-serif text-stone-900">
      ...
      <div className="absolute bottom-10 right-10 w-80 bg-[#fcfaf2] border-4 border-double border-stone-950 -rotate-3 shadow-[4px_4px_0_#111] p-5 z-0 pointer-events-none hidden lg:block text-stone-900 text-left">
        <div className="absolute -top-3 right-4 bg-red-800 text-white font-mono text-[9px] font-bold px-2 py-0.5 transform rotate-6 uppercase">
          TELEGRAM
        </div>
      ...
      <div className="w-full max-w-4xl z-10 bg-[#fcfaf2] border-4 border-double border-stone-950 p-4 shadow-[4px_4px_0_#111] animate-bounce-slight relative">
        ...
        <div className="p-2 sm:p-4 bg-[#fcfaf2]">
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1 bg-[#f5f2e9] border-2 border-stone-950 p-4 sm:p-6 relative rounded">
               ...
               <div className="p-4 sm:p-6 h-full relative overflow-hidden text-center">
                  ...
                  <div className="relative z-10 mb-6">
                    ...
                    <div className="mt-2 font-mono text-stone-700 text-[10px] bg-stone-200/50 inline-block px-3 py-1 border border-stone-300 rounded">
                      OPERATIVE: {email}
                    </div>
                  </div>
                  ...
                  <form onSubmit={handleVerifyOtp} className="flex flex-col gap-6 relative z-10 w-full max-w-xs mx-auto">
                    ...
                    {/* Digital Code Input */}
                    <div className="bg-white border-2 border-stone-950 p-4 shadow-sm relative rounded">
                      <input
                        type="text"
                        required
                        pattern="\d{6}"
                        ...
                        className="w-full bg-transparent border-none outline-none text-stone-950 font-mono text-4xl sm:text-5xl tracking-[0.35em] text-center placeholder-stone-300 focus:drop-shadow-[0_0_4px_rgba(0,0,0,0.1)] font-black"
                        placeholder="------"
                        autoFocus
                      />
                    </div>
                    ...
                    <div className="min-h-[50px] flex items-center justify-center">
                      ...
                      {status === "loading" && (
                        <div className="p-2 text-center border-2 border-stone-950 font-mono text-[10px] uppercase text-white bg-stone-950 animate-pulse w-full font-bold tracking-widest">
                    ...
                    <button 
                      type="submit" 
                      className="vintage-stamp w-full py-3.5 text-xs font-black"
            ...
            <div className="w-full md:w-[280px] flex flex-col justify-center gap-4 relative">
               ...
               <div className="bg-[#f4edd8] text-stone-900 p-5 border-2 border-stone-950 shadow-[4px_4px_0px_#111] transform rotate-2 relative z-10 rounded-sm text-left">
                  
                  {/* Stains */}
                  <div className="coffee-stain top-2 right-2 w-16 h-16 opacity-30"></div>
                  
                  {/* staple visual */}
                  <div className="absolute -top-1.5 left-1/2 -translate-x-1/2 w-8 h-3 bg-stone-400 border border-stone-600/30 transform rotate-1 rounded-sm z-30"></div>
