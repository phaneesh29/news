    ...
    <div className="min-h-screen w-screen bg-[#f5f2e9] flex flex-col p-4 sm:p-6 md:p-8 relative selection:bg-red-800/10 selection:text-stone-950 text-stone-900 font-serif">
        ...
        <div className="w-full flex flex-col relative lg:col-span-2">
          <div className="bg-[#fcfaf2] border-4 border-double border-stone-950 p-6 md:p-8 flex flex-col relative z-10 vintage-shadow-lg rounded">
            <div className="w-full flex justify-between items-center border-b-[4px] border-double border-black pb-4 mb-6">
              <div>
                <h3 className="font-['Playfair_Display',_Georgia,_serif] text-4xl sm:text-5xl font-black drop-shadow-sm text-black tracking-tighter uppercase leading-none select-none text-left">WRITE BLOG</h3>
        ...
        <div className="hidden lg:flex lg:col-span-1 flex-col relative w-full lg:sticky lg:top-8">
          <div className="bg-[#fcfaf2] border-[3px] border-black p-6 flex flex-col relative z-10 shadow-[4px_4px_0px_#111111] rounded">
            ...
            <div className="border-b-2 border-black pb-3 mb-5 text-left">
              <h3 className="font-['Playfair_Display',_Georgia,_serif] text-lg text-black uppercase tracking-wide font-black">EDITORIAL ASSISTANT</h3>
              <p className="font-mono text-[10px] text-stone-600 font-bold mt-1 tracking-wider uppercase">AUTOMATED WIRE DESPATCH</p>
            </div>
            <div className="flex-1 bg-[#fcfaf2] flex flex-col relative">
              <form onSubmit={handleAskAgent} className="flex flex-col gap-4 font-serif text-stone-900 text-left">
                <p className="font-serif text-xs text-stone-700 leading-relaxed">Provide instructions or a topic. The Staff Agent will search the web using <strong>Tavily Search</strong>, synthesize the details, and return a print-ready blog draft.</p>
                <div className="flex flex-col border-[2px] border-black p-3 bg-[#fcfaf2]">
                  <label className="font-mono text-[10px] font-bold text-black uppercase tracking-widest mb-1.5">Enter Topic or Wire Request:</label>
                ...
                <button type="submit" className="vintage-stamp w-full text-center py-3 bg-black text-[#fcfaf2] border-black hover:bg-stone-800 hover:text-[#fcfaf2] font-bold cursor-pointer text-xs" disabled={agentLoading || !agentQuery.trim()}>
      ...
      {injectionStatus.active && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-xs z-50 flex items-center justify-center p-6">
          <div className="max-w-md w-full bg-[#fcfaf2] border-4 border-double border-black p-8 flex flex-col gap-6 relative overflow-hidden">
            <h3 className="font-['Playfair_Display',_Georgia,_serif] text-black font-black text-xl uppercase tracking-widest text-center animate-pulse">PUBLISHING TO FEED</h3>
