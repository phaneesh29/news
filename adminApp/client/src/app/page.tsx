    ...
    <div className="min-h-screen w-screen bg-[#f5f2e9] flex flex-col p-4 sm:p-8 md:p-12 overflow-x-hidden relative selection:bg-red-800/10 selection:text-red-950 text-stone-900 font-serif">
      ...
      <div className="flex-1 flex flex-col lg:flex-row gap-12 lg:gap-16 min-h-0 relative z-10 max-w-[1400px] mx-auto w-full items-center justify-center">
        ...
        <div className="flex-[1.2] flex flex-col relative w-full group transition-all duration-500">
          ...
          <div className="bg-[#fcfaf2] border-4 border-double border-stone-950 p-6 sm:p-10 md:p-12 shadow-[4px_4px_0px_#111] flex flex-col relative rounded">
            
            {/* Stamp */}
            <div className="absolute top-6 right-6 border-4 border-red-800 text-red-800 font-playfair font-black text-xl p-1 px-3.5 transform rotate-[14deg] uppercase tracking-widest select-none opacity-85 z-20">
              UNCLASSIFIED
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10 flex-1">
              ...
              <div className="newspaper-column text-stone-900 font-serif text-sm leading-relaxed text-justify md:border-l md:border-stone-400/80 md:pl-6">
                ...
                <div className="mt-4 font-mono text-[10px] bg-stone-200/50 p-2.5 border border-stone-400 rounded relative overflow-hidden text-left">
        ...
        <div className="flex-1 flex flex-col relative w-full group">
          ...
          <div className="bg-[#fcfaf2] border-4 border-double border-stone-950 p-6 sm:p-8 flex flex-col h-full min-h-[500px] shadow-[4px_4px_0px_#111] rounded">
            ...
            <div className="flex-1 flex flex-col gap-4 text-xs text-stone-850 text-left">
              ...
              <div className="flex flex-col gap-1.5 mt-4 bg-[#f5f2e9] border border-stone-400 p-3 rounded">
                <span className="text-[9px] font-mono text-stone-600 uppercase tracking-widest font-bold">WIRE DEPATCH FEED LOG</span>
                <div className="font-mono text-[10px] text-stone-850 leading-relaxed space-y-0.5">
            ...
            <div className="mt-8 pt-4 border-t border-stone-300">
              <Link 
                href="/login"
                className="vintage-stamp w-full flex items-center justify-center py-4 bg-transparent border-2 border-stone-950 font-playfair font-black text-base uppercase tracking-widest text-center hover:bg-stone-950 hover:text-white"
              >
                ENTER WIRE CONSOLE
              </Link>
            </div>
