...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-screen bg-[#f5f2e9] flex items-center justify-center p-4 sm:p-8 relative selection:bg-red-800/10 selection:text-red-950 text-stone-900 font-serif">
      ...
      <div className="bg-[#fcfaf2] border-4 border-double border-stone-950 w-full max-w-5xl z-10 relative p-4 rounded shadow-[4px_4px_0px_#111] animate-bounce-slight">
          ...
          <main className="bg-[#fcfaf2] relative flex w-full flex-col p-6 sm:p-10 md:p-12 md:flex-row z-20">
            ...
            <div className="flex-1 pr-0 md:pr-10 border-b-4 md:border-b-0 md:border-r-2 border-stone-950 mb-8 md:mb-0 pb-8 md:pb-0 relative text-stone-900">
              ...
              <div className="border-b-4 border-double border-stone-950 pb-2.5 mb-4">
                ...
                <h1 className="font-playfair text-4xl sm:text-5xl lg:text-6xl font-black text-center tracking-tighter uppercase leading-[0.85] mb-2 transform -skew-x-2 text-stone-950">
                  <span className="text-red-800">BREACH</span> REPORT
                </h1>
              </div>
              
              <div className="bg-stone-950 text-[#fcfaf2] py-1 text-center font-mono text-[10px] tracking-widest uppercase mb-6 shadow-[-3px_3px_0_#801c1c] font-bold">
              ...
              {/* Graphic */}
              <div className="mt-8 border-2 border-stone-950 p-4 rotate-2 bg-[#f5f2e9] relative max-w-[280px] mx-auto">
                <div className="absolute -top-3.5 -right-2 bg-red-850 text-white font-mono text-[9px] font-bold px-2 py-0.5 transform rotate-6 uppercase">
                  CLASSIFIED
                </div>
            ...
            <div className="flex-1 md:pl-10 flex flex-col justify-center relative">
              ...
              {/* Dossier Card body */}
              <div className="bg-[#f4edd8] border-2 border-stone-950 p-6 sm:p-8 shadow-[6px_6px_0px_#111] transform -rotate-1 rounded">
                ...
                <div className="border-b-2 border-stone-950 pb-2 mb-6 flex justify-between items-end">
                  ...
                  <span className="font-mono text-[9px] text-white bg-stone-950 px-2 py-0.5 font-bold uppercase tracking-widest">
                    REQ_OTP
                  </span>
                </div>
                ...
                <form onSubmit={handleRequestOtp} className="flex flex-col gap-6">
                  ...
                  {status !== "idle" && (
                    <div className={`p-3 text-center border-2 font-mono text-xs uppercase font-bold tracking-wider ${status === "error" ? "border-red-700 text-red-700 bg-red-50" : "border-stone-950 text-white bg-stone-950"}`}>
                  ...
                  <div className="mt-8 flex flex-col items-center">
                    <button 
                      type="submit" 
                      className="vintage-stamp w-full text-lg py-3 uppercase tracking-widest font-black"
                      disabled={status === "loading"}
                    >
                      SEND ACCESS CODE
                    </button>
                    
                    <Link href="/" className="font-mono text-[10px] text-stone-500 uppercase tracking-widest mt-4 hover:underline">
                      &lt; Back to Archives
                    </Link>
                  </div>
